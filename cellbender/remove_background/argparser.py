...
def add_subparser_args(subparsers: argparse._SubParsersAction) -> argparse._SubParsersAction:
    ...
    subparser = subparsers.add_parser(
        "remove-background",
        description="Remove background RNA from count matrix.",
    ...
    subparser.add_argument(
        ...
        required=False,
        default=consts.CHECKPOINT_FILE_NAME,
    ...
    subparser.add_argument(
        ...
        help="Number of cells expected in the dataset (a rough estimate within a factor of 2 is sufficient).",
    )
    subparser.add_argument(
    ...
    subparser.add_argument(
        ...
        help="Ignore CellBender's heuristic prior estimation, and use this prior for UMI counts in cells.",
    )
    subparser.add_argument(
        ...
        help="Ignore CellBender's heuristic prior estimation, and use this prior for UMI counts in empty droplets.",
    )
    subparser.add_argument(
        "--model",
        nargs=None,
    ...
    subparser.add_argument(
        "--epochs", nargs=None, type=int, default=150, dest="epochs", help="Number of epochs to train."
    )
    subparser.add_argument(
        "--low-count-threshold",
        type=int,
    ...
    subparser.add_argument("--z-dim", type=int, default=64, dest="z_dim", help="Dimension of latent variable z.")
    subparser.add_argument(
        "--z-layers",
        nargs="+",
        type=int,
    ...
    subparser.add_argument(
        ...
        help="Feature types to ignore during the analysis.  These features will be left unchanged in the output file.",
    )
    subparser.add_argument(
    ...
    subparser.add_argument(
        ...
        default=7.0,
        dest="checkpoint_min",
        help="Checkpoint file will be saved periodically, with this many minutes between each checkpoint.",
    )
    subparser.add_argument(
    ...
    subparser.add_argument(
        ...
        help="Tunable parameter q for the CDF threshold estimation method (not normally used: see documentation).",
    )
    subparser.add_argument(
        "--estimator",
        type=str,
    ...
    subparser.add_argument(
        ...
        dest="use_multiprocessing_estimation",
        action="store_true",
        default=False,
    ...
    subparser.add_argument(
        ...
        dest="debug",
        action="store_true",
        help="Including the flag --debug will log extra messages useful for debugging.",
    )
    subparser.add_argument(
        "--truth",
        type=str,
